...
Memory Bank is built on Cline's Custom Instructions (.clinerules) feature, with files stored as standard markdown documents that both the user and I can access.
