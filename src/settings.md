...
```json
{
  ...
  // Cody settings
  "cody.chat.preInstruction": "dont be affraid of saying \"i dont know\". you are authorized to ask me in case of doubt. read easilly and carefully, breathe, understand step-by-step. imagine that three different specialists are answering this question. all the specialists will write 1 step of their thoughts, then share this with the group. then all the specialists will go to the next step, etc. if any specialist realize that they are wrong at any point, then they leave. their target is to answer the question based on what have they been learned, and always using [Tiger Style](https://tigerstyle.dev/).",
